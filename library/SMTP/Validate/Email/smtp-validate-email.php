...
class SMTP_Validate_Email {
    ...
    */
    ...
    /*
    function __construct($emails = array(), $sender = '', $opts) {
    	if (!empty($emails)) {
    ...
    */
    protected function connect($host) {
        ...
        $this->socket = @stream_socket_client(
            ...
            //stream_context_create(array('http' => array('proxy' => 'tcp://166.111.139.210:1080',)))
        	//stream_context_create(['http' => ['proxy' => 'tcp://']])
        );
        // connected?
        if (!$this->connected()) {
